...
describe("murlifier", () => {
  ...
  describe("findNextToken", () => {
    it("次の形態素を返すこと", () => {
      ...
      expect(murlifier.findNextToken(tokens[0], tokens)).toBe(tokens[1]);
    });
    it("句点を文の終わりと認識すること", () => {
      const tokens = [
        {
      ...
      expect(murlifier.isLastToken(tokens[0], tokens)).toBe(true);
    });
    it("読点を文の終わりと認識すること", () => {
      const tokens = [
        {
      ...
      expect(murlifier.isLastToken(tokens[0], tokens)).toBe(false);
    });
  });
  describe("isLastToken", () => {
    it("最後の形態素を文の終わりと認識すること", () => {
      const tokens = [
        {
          word_id: 22540,
          word_type: "KNOWN",
